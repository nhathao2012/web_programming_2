  ...
  Vue.component('product-review', {
    template: `
      <form class="review-form" @submit.prevent="onSubmit">
        ...
        <label>
          Yes
          <input type="radio" value="Yes" v-model="recommend"/> <!-- Challenge 10 -->
        </label>
        <label>
          No
      ...
      onSubmit() {
        ...
        if(this.name && this.review && this.rating && this.recommend) {
          let productReview = {
            ...
            review: this.review,
            rating: this.rating,
            recommend: this.recommend //Challenge 10
          }
          this.$emit('review-submitted', productReview)
          this.name = null
          this.review = null
          this.rating = null
          this.recommend = null //Challenge 10
        } else {
          if(!this.name) this.errors.push("Name required.")
          if(!this.review) this.errors.push("Review required.")
          if(!this.rating) this.errors.push("Rating required.")
          if(!this.recommend) this.errors.push("Recommendation required.") //Challenge 10
        }
      }
    }
  })
